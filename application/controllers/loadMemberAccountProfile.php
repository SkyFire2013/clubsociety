<div style="width:500px;" class="box box-success">
    <div class="box-header" style="cursor: move;">
        <h3 class="box-title">Club post</h3>
    </div>
    ...
    </div><div class="slimScrollBar" style="width: 7px; position: absolute; top: 93px; opacity: 0.4; display: none; border-radius: 0px; z-index: 99; right: 1px; height: 157.035175879397px; background: rgb(0, 0, 0);"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 0px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(51, 51, 51);"></div></div><!-- /.chat -->
